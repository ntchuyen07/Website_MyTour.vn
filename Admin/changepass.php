...
<body>
	...
	<div class="container-fuild ctnf_acc" style="margin-top:0px;">
		<div class="container" style="padding-bottom: 100px;margin-left: 20%;">
			<div class="row">
			<div class="col-md-7 col-xs-7 ctn_acc cont">
	            ...
	            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
	                ...
	                <div class="form-group">
	                    ...
	                    <input type="password" name="newpassag" class="form-control" required>
	        ...
	        <div class="col-md-4 col-xs-4" style="text-align: center;margin-top: 100px;padding-left: 20px;">
