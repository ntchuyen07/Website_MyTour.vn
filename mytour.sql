...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 16, 2021 lúc 04:51 AM
...
CREATE TABLE `account` (
  ...
  `passsave` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `account` (`id`, `username`, `password`, `passsave`, `name`, `image`, `email`, `phone`, `address`, `role`, `code`, `toggle`) VALUES
(1, 'admin', 'e24bfe242ea35f40bfa6826a2076eef0', '07112020', 'MyTour.vn', 'image/B612_20201101_195847_311.jpg', 'ntchuyen.19it1@vku.udn.vn', '0967765522', '470 Trần Đại Nghĩa, phường Hòa Hải, quận Ngũ Hành Sơn,Thành phố Đà Nẵng', 1, '', 0),
...
CREATE TABLE `bills` (
  ...
  `showname` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(10, 2, 'Nguyễn Thị Cẩm Huyền', 'camhuyen772001@gmail.com', '0987783627', 'Kí túc xá Trường Đại học Công nghệ thông tin và Truyền thông Việt - Hàn, phường Hòa Quý, quận Ngũ Hành Sơn, thành phố Đà Nẵng', '2021-01-14 15:54:03', 18, 6, 1937000, '2021-01-16 14:00:00', '2021-01-17 11:00:00', 1, 1937000, 'Thẻ ATM nội địa', 2, 0, '', ''),
(11, 20, 'Hồ Thanh Phong', 'htphong.19it1@vku.udn.vn', '0123456789', 'TP Huế, Thừa Thiên - Huế', '2021-01-15 09:52:30', 7, 6, 1090000, '2021-01-17 14:00:00', '2021-01-19 11:00:00', 2, 4360000, 'Thẻ ATM nội địa', 2, 0, '', ''),
(12, 11, 'Donald Trump', 'htphong.19it1@vku.udn.vn', '0987664321', 'White House, Washington, America', '2021-01-15 11:33:17', 11, 11, 747000, '2021-01-17 14:00:00', '2021-01-19 11:00:00', 5, 7470000, 'Thẻ tín dụng', 2, 0, '', ''),
...
(14, 4, 'trucly', 'nttly.19it1@vku.udn.vn', '0327216383', ' 01 An Thượng, Mỹ An, Ngũ Hành Sơn, Đà Nẵng', '2021-01-15 13:36:39', 1, 1, 733000, '2021-01-22 14:00:00', '2021-01-24 11:00:00', 2, 2932000, 'Thẻ tín dụng', 2, 0, '', ''),
...
(16, 20, 'Thanh Phong', 'htphong.19it1@vku.udn.vn', '0795525037', 'TP Huế, Thừa Thiên - Huế', '2021-01-11 23:03:21', 18, 6, 1937000, '2021-01-10 14:00:00', '2021-01-14 11:00:00', 1, 9685000, 'Thẻ tín dụng', 4, 5, 'Nói thật, nếu hệ thống đánh giá này có 10 sao, tôi nhất định sẽ cho 10 sao. Khách sạn Vinpearl là một khách sạn tuyệt vời. Với nội thất tiện nghi, không gian thoáng đãng, phục vụ nhiệt tình, đặc biệt là anh quản lý rất là thân thiện. Tôi nhất định sẽ quay trở lại sử dụng dịch vụ ở đây.', 'Thanh Phong'),
...
(19, 11, 'Donald Trump', 'htphong.19it1@vku.udn.vn', '0987664321', 'White House, Washington, America', '2021-01-11 11:33:17', 11, 11, 747000, '2021-01-17 14:00:00', '2021-01-19 11:00:00', 5, 7470000, 'Thẻ tín dụng', 2, 0, '', ''),
(20, 7, 'Ngô Thị Hương Giang', 'nthgiang.19it1@vku.udn.vn', '0327216383', 'phường Hòa Hải, quận Ngũ Hành Sơn, Thành phố Đà Nẵng', '2021-01-16 07:40:43', 1, 1, 733000, '2021-01-21 14:00:00', '2021-01-24 11:00:00', 1, 2199000, 'Thẻ tín dụng', 2, 0, '', ''),
(21, 7, 'Ngô Thị Hương Giang', 'camhuyen772001@gmail.com', '0327216383', 'phường Hòa Hải, quận Ngũ Hành Sơn, Thành phố Đà Nẵng', '2021-01-16 07:43:50', 18, 6, 1937000, '2021-01-17 14:00:00', '2021-01-19 11:00:00', 2, 7748000, 'Thẻ tín dụng', 1, 0, '', ''),
...
CREATE TABLE `booking` (
  ...
  `address` varchar(455) COLLATE utf8mb4_unicode_ci NOT NULL,
  `room` varchar(455) COLLATE utf8mb4_unicode_ci NOT NULL,
  `pay` tinyint(4) NOT NULL DEFAULT 0,
  `bookday` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `dayleave` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `priceRoom` varchar(455) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `booking` (`id`, `Customer`, `Contact`, `address`, `room`, `pay`, `bookday`, `dayleave`, `priceRoom`, `payment`, `numberRoom`) VALUES
...
CREATE TABLE `category` (
  `id` int(11) NOT NULL,
  `namecate` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `parent_id` int(11) NOT NULL,
  `decscription` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `category` (`id`, `namecate`, `parent_id`, `decscription`) VALUES
...
CREATE TABLE `chart` (
  `id` int(100) NOT NULL,
  `namehotel` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `chart` (`id`, `namehotel`, `star`, `coment`, `1sao`, `2sao`, `3sao`, `4sao`, `5sao`) VALUES
...
INSERT INTO `comment` (`id`, `content`, `parent_id`, `user`, `idpost`, `datecmt`, `isShow`, `likecmt`) VALUES
(3, 'Mỳ Quảng có phải đặc sản của Đà Nẵng hông vậy?', 0, 2, 3, '2021-01-14 17:18:00', 0, 4),
(4, 'Không hẳn bạn ạ', 3, 3, 3, '2021-01-14 17:50:00', 0, 0),
(5, 'Xin chào Việt Nam!', 0, 11, 3, '2021-01-14 21:51:01', 0, 3),
(6, 'Bài viết rất hay và hữu ích', 0, 11, 3, '2021-01-14 23:34:07', 0, 1),
(23, 'Hello VietNam', 3, 11, 3, '2021-01-15 00:41:13', 0, 0),
...
CREATE TABLE `contact` (
  ...
  `reply` varchar(5000) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `contact` (`id`, `user`, `name`, `email`, `content`, `date_send`, `reply`) VALUES
...
(2, 2, 'Nguyễn Thị Cẩm Huyền', 'camhuyen772001@gmail.com', '<p>Xin ch&agrave;o admin,&nbsp;</p>\r\n\r\n<p>M&igrave;nh đ&atilde; đặt v&eacute; du lịch đến Đ&agrave; Nẵng v&agrave;o ng&agrave;y 1/2 tới. V&igrave; vậy m&igrave;nh đang t&igrave;m kiếm một kh&aacute;ch sạn để lưu lại Đ&agrave; Nẵng trong khoảng 3 ng&agrave;y.&nbsp;</p>\r\n\r\n<p>Nhưng m&igrave;nh kh&ocirc;ng biết nhiều về nơi n&agrave;y lắm.</p>\r\n\r\n<p>Vậy admin c&oacute; thể tư vấn cho m&igrave;nh v&agrave;i kh&aacute;ch sạn uy t&iacute;n m&agrave; gi&aacute; cả phải chăng kh&ocirc;ng?</p>\r\n\r\n<p>Cảm ơn admin nhiều</p>\r\n', '2021-01-14 09:14:28', '<p>Xin ch&agrave;o bạn,cảm ơn bạn đ&atilde; li&ecirc;n hệ với&nbsp;ch&uacute;ng t&ocirc;i.</p>\r\n\r\n<p>Ch&agrave;o bạn Nguyễn Thị Cẩm Huyền, rất vui khi nhận được lời nhắn từ bạn.</p>\r\n\r\n<p>Theo như t&ocirc;i thấy, nếu bạn muốn lựa chọn dịch vụ kh&aacute;ch sạn sang trọng, cao cấp th&igrave; c&oacute; thể lựa chọn Golden Bay, Vinpearl Condotel&nbsp;</p>\r\n\r\n<p>Nếu chọn chất lượng khoảng từ 4 sao với gi&aacute; cả phải chăng, dịch vụ tốt th&igrave; c&oacute; thể chọn Sala Beach Đ&agrave; Nẵng</p>\r\n\r\n<p>C&ograve;n nếu bạn c&oacute; chuyến du lịch với gia đ&igrave;nh, ch&uacute;ng t&ocirc;i nghĩ rằng bạn c&oacute; thể suy nghĩ về việc đặt một homesaty. Như vậy sẽ khiến mọi người thấy thoải m&aacute;i v&agrave; c&ugrave;ng nhau trải nghiệm nhiều thứ th&uacute; vị hơn!</p>\r\n\r\n<p>Hen gặp lại bạn!</p>\r\n'),
(3, 3, 'Hồ Thanh Phong', 'htphong.19it1@vku.udn.vn', '<p>Xin ch&agrave;o Admin, sắp tới m&igrave;nh c&oacute; chuyến c&ocirc;ng t&aacute;c đến Đ&agrave; Nẵng.&nbsp;</p>\r\n\r\n<p>Bạn c&oacute; thể tư vấn cho m&igrave;nh một dịch vụ nghỉ dưỡng lưu tr&uacute; tiện nghi v&agrave; thoải m&aacute;i được kh&ocirc;ng</p>\r\n\r\n<p>Th&ecirc;m nữa l&agrave; ch&iacute;nh s&aacute;ch đặt ph&ograve;ng b&ecirc;n m&igrave;nh sao ạ?</p>\r\n', '2021-01-15 02:08:02', '<p>Xin ch&agrave;o bạn Hồ Thanh Phong,</p>\r\n\r\n<p>M&igrave;nh đ&atilde; đọc được thắc mắc của bạn. V&agrave; m&igrave;nh xin được tư vấn cũng như giải đ&aacute;p thắc mắc như sau:</p>\r\n\r\n<p>Về kh&aacute;ch sạn tiện nghi bạn c&oacute; thể lựa chọn Vinpearl Condotel hoặc Golden Bay.</p>\r\n\r\n<p>C&ograve;n về ch&iacute;nh s&aacute;ch đặt ph&ograve;ng, ph&iacute; đặt b&ecirc;n MyTour l&agrave; ho&agrave;n to&agrave;n miễn ph&iacute;, bạn sẽ trả trước 30% th&ocirc;ng qua nhiều phương thức t&ugrave;y bạn lựa chọn.</p>\r\n\r\n<p>Số tiền c&ograve;n lại đến h&ocirc;m nhận ph&ograve;ng bạn sẽ thanh to&aacute;n cho b&ecirc;n kh&aacute;ch sạn ạ</p>\r\n\r\n<p>Hẹn gặp lại bạn lần sau!</p>\r\n'),
(4, 20, 'Phong Thanh Hồ', 'htphong.19it1@vku.udn.vn', '<p>M&igrave;nh ở Huế, nhưng m&igrave;nh muốn đến Đ&agrave; Nẵng vui chơi khắp chốn đến hết mới th&ocirc;i</p>\r\n\r\n<p>N&ecirc;n c&oacute; thể m&igrave;nh sẽ ở lại Đ&agrave; Nẵng trong v&agrave;i ng&agrave;y.</p>\r\n\r\n<p>Admin giới thiệu cho m&igrave;nh một v&agrave;i homestay hoặc kh&aacute;ch sạn gi&aacute; rẻ m&agrave; chất lượng tốt được kh&ocirc;ng?</p>\r\n\r\n<p>Cảm ơn Admin</p>\r\n', '2021-01-15 10:07:33', ''),
(5, 20, 'Thanh Phong', 'htphong.19it1@vku.udn.vn', '<p>T&ocirc;i sắp đến Đ&agrave; Nẵng để du lịch v&agrave;o dịp Tết Nguy&ecirc;n Đ&aacute;n n&agrave;y. T&ocirc;i c&oacute; t&igrave;m hiểu qua một v&agrave;i kh&aacute;ch sạn nhưng chưa được ứng &yacute; cho lắm. C&aacute;c bạn c&oacute; thể gợi &yacute; cho t&ocirc;i 1 v&agrave;i kh&aacute;ch sạn thật luxury để t&ocirc;i c&oacute; thể tận hưởng v&agrave;o dịp Tết n&agrave;y kh&ocirc;ng ?<br />\r\nc&aacute;m ơn c&aacute;c bạn.</p>\r\n', '2021-01-15 23:13:33', '<p>Bạn c&oacute; thể li&ecirc;n hệ Hồ Thanh Phong - quản l&yacute; của kh&aacute;ch sạn Vinpearl Condotel Đ&agrave; Nẵng nh&eacute;. Bạn n&agrave;y cực kỳ th&acirc;n thiện. Nhất định bạn sẽ t&igrave;m được 1 kh&aacute;ch sạn ứng &yacute;. Ch&uacute;c bạn may mắn.&nbsp;<br />\r\nTh&acirc;n &aacute;i, ch&agrave;o bạn.</p>\r\n');
...
CREATE TABLE `hotel` (
  ...
  `admin_hotel` int(11) NOT NULL,
  `decscription` varchar(6000) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Cấu trúc bảng cho bảng `imageshotel`
--
...
--
-- Đang đổ dữ liệu cho bảng `imageshotel`
--

INSERT INTO `imageshotel` (`id`, `image`, `idhotel`, `uploaded`) VALUES
...
--
-- Cấu trúc bảng cho bảng `imagespost`
--
...
--
-- Cấu trúc bảng cho bảng `imagesrooms`
--
...
--
-- Đang đổ dữ liệu cho bảng `imagesrooms`
--
...
INSERT INTO `likecomment` (`id`, `user`, `idcmt`, `toggle`) VALUES
(1, 11, 3, 1),
(2, 2, 3, 1),
(3, 2, 5, 1),
(4, 2, 6, 1),
...
CREATE TABLE `post` (
  ...
  `checkpost` int(11) NOT NULL,
  `slug` varchar(700) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `role` (
  `id` int(11) NOT NULL,
  `namerole` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `rooms` (
  `id` int(11) NOT NULL,
  `nameroom` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `amount` int(11) NOT NULL,
  `price` float NOT NULL,
  ...
  `decscription` varchar(2000) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `rooms` (`id`, `nameroom`, `image`, `amount`, `price`, `final_price`, `policy`, `area`, `direction`, `beds`, `breakfast`, `decscription`, `discount`, `hotel`, `type`, `maximum`, `status`) VALUES
...
(7, 'Studio Suite (Khách Việt Nam)', 'image/3afb332d2ac982be9099d3d4f90a50c4.jpg', 12, 3115000, 1090000, 0, 28, 'Hướng trung tâm thành phố', '2 giường đơn rất lớn', 1, '<p><strong>Lưu &yacute;:</strong></p>\r\n\r\n<ul>\r\n	<li>C&aacute;c mức ph&iacute; tr&ecirc;n chưa bao gồm thuế, ph&iacute;</li>\r\n	<li>Giường phụ kh&ocirc;ng &aacute;p dụng cho loại ph&ograve;ng Studio Suite (Kh&aacute;ch Việt Nam), Quang cảnh Th&agrave;nh Phố</li>\r\n	<li>1 ph&ograve;ng được th&ecirc;m tối đa v&agrave; 1 trẻ em (tuỳ v&agrave;o loại ph&ograve;ng)</li>\r\n	<li>Trẻ từ 12 tuổi trở l&ecirc;n được t&iacute;nh như người lớn</li>\r\n	<li>Vui l&ograve;ng nhập c&aacute;c y&ecirc;u cầu đặc biệt v&agrave;o mục Y&ecirc;u cầu kh&aacute;c b&ecirc;n dưới</li>\r\n	<li>Th&ocirc;ng tin li&ecirc;n hệ để được hỗ trợ</li>\r\n</ul>\r\n\r\n<p><strong>Ch&iacute;nh s&aacute;ch hủy</strong><br />\r\nĐ&acirc;y l&agrave; gi&aacute; đặc biệt n&ecirc;n kh&ocirc;ng được ho&agrave;n huỷ.<br />\r\nBạn sẽ kh&ocirc;ng được ho&agrave;n trả tiền khi thay đổi hay huỷ đơn đặt ph&ograve;ng n&agrave;y.</p>\r\n', 65, 6, 1, 2, 8),
...
INSERT INTO `status` (`id`, `name`, `decscription`) VALUES
...
--
-- Cấu trúc bảng cho bảng `typeroom`
--
...
--
-- Đang đổ dữ liệu cho bảng `typeroom`
--

INSERT INTO `typeroom` (`id`, `name`, `decscription`) VALUES
(1, 'VIP', ''),
(2, 'Thường', '');
...
ALTER TABLE `comment`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user` (`user`),
  ADD KEY `comment_ibfk_2` (`parent_id`);
...
--
-- AUTO_INCREMENT cho bảng `imageshotel`
--
ALTER TABLE `imageshotel`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT cho bảng `imagespost`
--
ALTER TABLE `imagespost`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `imagesrooms`
--
ALTER TABLE `imagesrooms`
...
--
-- AUTO_INCREMENT cho bảng `typeroom`
--
ALTER TABLE `typeroom`
...
--
ALTER TABLE `bills`
  ADD CONSTRAINT `bills_ibfk_1` FOREIGN KEY (`room`) REFERENCES `rooms` (`id`),
  ADD CONSTRAINT `bills_ibfk_2` FOREIGN KEY (`user`) REFERENCES `account` (`id`),
  ADD CONSTRAINT `bills_ibfk_3` FOREIGN KEY (`status`) REFERENCES `status` (`id`);

--
-- Các ràng buộc cho bảng `comment`
--
ALTER TABLE `comment`
  ADD CONSTRAINT `comment_ibfk_3` FOREIGN KEY (`user`) REFERENCES `account` (`id`);

--
-- Các ràng buộc cho bảng `hotel`
--
ALTER TABLE `hotel`
  ADD CONSTRAINT `hotel_ibfk_1` FOREIGN KEY (`id_address`) REFERENCES `address` (`id`),
  ADD CONSTRAINT `hotel_ibfk_2` FOREIGN KEY (`cate`) REFERENCES `category` (`id`);

--
-- Các ràng buộc cho bảng `imageshotel`
--
ALTER TABLE `imageshotel`
  ADD CONSTRAINT `imageshotel_ibfk_1` FOREIGN KEY (`idhotel`) REFERENCES `hotel` (`id`);

--
-- Các ràng buộc cho bảng `imagespost`
--
ALTER TABLE `imagespost`
  ADD CONSTRAINT `imagespost_ibfk_1` FOREIGN KEY (`idpost`) REFERENCES `post` (`id`);

--
-- Các ràng buộc cho bảng `imagesrooms`
--
ALTER TABLE `imagesrooms`
  ADD CONSTRAINT `imagesrooms_ibfk_1` FOREIGN KEY (`idroom`) REFERENCES `rooms` (`id`);

--
-- Các ràng buộc cho bảng `post`
--
ALTER TABLE `post`
  ADD CONSTRAINT `post_ibfk_1` FOREIGN KEY (`user`) REFERENCES `account` (`id`);

--
-- Các ràng buộc cho bảng `rooms`
--
ALTER TABLE `rooms`
  ADD CONSTRAINT `rooms_ibfk_1` FOREIGN KEY (`type`) REFERENCES `typeroom` (`id`),
  ADD CONSTRAINT `rooms_ibfk_2` FOREIGN KEY (`hotel`) REFERENCES `hotel` (`id`);
COMMIT;
